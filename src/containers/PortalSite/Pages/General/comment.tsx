            ...
            <div id="main_comment" style={{ padding: "10px 10px" }}>
              <div className="d-flex mb-3">
                ...
                <div style={{ marginLeft: "10px" }}>
                  ...
                  <p style={{ fontSize: "calc(1rem * 0.8)", color: "gray" }}>
              ...
              <p
                ...
                style={{ textAlign: "justify", fontSize: "calc(1rem * 0.8)" }}
              >
                {val.cons}
              </p>
              {val.stat ? (
                ...
                <p
                  ...
                  style={{ cursor: "pointer", fontSize: "calc(1rem * 0.8)" }}
                >
                  Phản hồi
                </p>
              )}
