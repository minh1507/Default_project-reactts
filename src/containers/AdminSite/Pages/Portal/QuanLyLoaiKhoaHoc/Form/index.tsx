...
import LoaiKhoaHocFormInputJson from "./FormInput.json";
interface Props {
  Id: string;
  ReloadTableItems: any;
}

const LoaiKhoaHocForm = (props: Props) => {
  ...
  let LoaiKhoaHocFormInput: any = LoaiKhoaHocFormInputJson;
...
export default connect(mapState, mapDispatchToProps)(LoaiKhoaHocForm);
