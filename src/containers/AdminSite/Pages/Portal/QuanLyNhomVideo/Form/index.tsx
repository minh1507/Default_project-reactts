...
import NhomVideoFormInputJson from "./FormInput.json";
interface Props {
  Id: string;
  ReloadTableItems: any;
}

const NhomVideoForm = (props: Props) => {
  const [state, dispatch] = useReducer(Reducer, InitState);
  useEffect(() => {
    Actions.GetItem(props.Id, dispatch);
  }, [props.Id]);
  let NhomVideoFormInput: any = NhomVideoFormInputJson;
...
export default connect(mapState, mapDispatchToProps)(NhomVideoForm);
