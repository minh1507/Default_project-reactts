...
import GiaoDienFormInputJson from "./FormInput.json";
interface Props {
  Id: string;
  ReloadTableItems: any;
}

const GiaoDienForm = (props: Props) => {
  ...
  let GiaoDienFormInput: any = GiaoDienFormInputJson;
...
export default connect(mapState, mapDispatchToProps)(GiaoDienForm);
