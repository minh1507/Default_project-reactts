...
const RoleList = (props: Props) => {  
    ...
    const DialogMemo = useMemo(() => {
        return <>
        {dialogVisible == true ?
            <CDialog title={roleId ? "Sửa nhóm sự kiện": "Tạo mới nhóm sự kiện"} dialogVisible={dialogVisible} onCancel={() => setDialogVisible(false)}>
    ...
    return(
        <>
            <CConfirm ref={refConfirm_DeleteItem} Title="Thao tác này sẽ xóa nhóm sự kiện" Ok={async () => {await DeleteById()}} Canel={()=>{}} />
