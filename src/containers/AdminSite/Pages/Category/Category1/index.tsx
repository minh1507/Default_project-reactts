...
const CategoryList = (props: Props) => {  
    ...
    const DialogMemo = useMemo(() => {
        return <>
        {dialogVisible == true ?
            <CDialog title={categoryId ? "Sửa danh mục 1": "Tạo mới danh mục 1"} dialogVisible={dialogVisible} onCancel={() => setDialogVisible(false)}>
    ...
    return(
        <>
            <CConfirm ref={refConfirm_DeleteItem} Title="Thao tác này sẽ xóa danh mục 1" Ok={async () => {await DeleteById()}} Canel={()=>{}} />
