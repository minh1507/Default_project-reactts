...
const Login = (props: Props) => {
  ...
  const [InputSignupSocial, setInputSignupSocial] = useState({
    Type: "",
    FullName: "",
    UserName: "",
    Password: "",
  ...
  const SendEmail = async () => {
    ...
    let res: IResponseMessage = await props.SendEmailRestorePassword(
      address,
      Email_RestorePassword
    );
    if (res && res.Success) {
      refNotification.current.showNotification("success", res.Message);
  ...
  return (
    <>
      ...
      <CDialog
        ...
        dialogVisible={dialogVisible_RestorePassword}
        onCancel={() => setDialogVisible_RestorePassword(false)}
      >
        <div className="row g-3 needs-validation form-register">
          <div className="col-12">
            <CInput
              placeholder="Email"
              value={Email_RestorePassword}
              onChange={(e: any) => {
                setEmail_RestorePassword(e);
              }}
            />
          </div>
          <div className="col-12">
      ...
      <CDialog
        ...
        dialogVisible={dialogVisible_SocialLogin}
        onCancel={() => setDialogVisible_SocialLogin(false)}
      >
        <div className="row g-3 needs-validation form-register">
          <div className="col-12">
            <CInput
              disabled={true}
              placeholder="Email"
              value={InputSignupSocial.Email}
              onChange={(e: any) => {
                onChangeFormSignupSocial("Email", e);
              }}
            />
            <label style={{ color: "#1B74E4", fontSize: "0.9em" }}>
              <b>Email đã được xác thực bởi {InputSignupSocial.Type}</b>
            </label>
          </div>
          <div className="col-12">
            <CInput
              placeholder="Họ và tên"
              value={InputSignupSocial.FullName}
              onChange={(e: any) => {
                onChangeFormSignupSocial("FullName", e);
              }}
            />
          </div>
          <div className="col-12">
            <CInput
              ...
              value={InputSignupSocial.UserName}
              onChange={(e: any) => {
                onChangeFormSignupSocial("UserName", e);
              }}
            />
          </div>
          <div className="col-12">
            <CInput
              ...
              type="password"
              value={InputSignupSocial.Password}
              onChange={(e: any) => {
                onChangeFormSignupSocial("Password", e);
              }}
            />
          </div>
          <div className="col-12">
                  ...
                  <div className="row g-3 needs-validation form-login">
                    ...
                    <div className="col-12">
                      <p className="small mb-0">
                        ...
                        >
                          &ensp;Đăng ký tài khoản
                        </a>
                        &ensp;*&ensp;
                        <a
                          className="link"
                          onClick={() => {
                            setDialogVisible_RestorePassword(true);
                          }}
                        >
                          Khôi phục mật khẩu
                        </a>
