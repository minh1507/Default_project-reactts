...
const Profile = (props: Props) => {
  ...
  const handleKeyDown = (event: any) => {
    if (event.keyCode == 13) {
      ...
      if (tagNameFocus !== "button") {
        ...
        let tab_change_password = document.getElementById(
          "tab_change_password"
        );
  ...
  const ValidateFormChangePassword = () => {
    if (!InputChangePassword.PasswordOld) {
      refNotification.current.showNotification(
        "warning",
        Message.OldPassword_Is_Not_Empty
      );
      return false;
    }
    if (!InputChangePassword.PasswordNew) {
      refNotification.current.showNotification(
        "warning",
        Message.NewPassword_Is_Not_Empty
      );
      return false;
    }
    return true;
  ...
  const ChangePassword = async () => {
    if (ValidateFormChangePassword()) {
      let res: IResponseMessage = await props.ChangePassword(
        InputChangePassword
      );
      if (res && res.Success) {
                    ...
                    <form style={{ width: "50%" }}>
                      <div className="row mb-3">
                        <CInput
                          ...
                          onChange={(e: any) => {
                            onChange_InputProfile("FullName", e);
                          }}
                        />
                      </div>
                      <div className="row mb-3">
                        <CInput
                          ...
                          onChange={(e: any) => {
                            onChange_InputProfile("UserName", e);
                          }}
                        />
                      </div>
                      <div className="row mb-3">
                      ...
                      <div className="row mb-3">
                        <CInput
                          ...
                          onChange={(e: any) => {
                            onChange_InputProfile("Address", e);
                          }}
                        />
                      </div>
                    ...
                    <form style={{ width: "50%" }}>
                      <div className="row mb-3">
                        <CInput
                          ...
                          value={InputChangePassword.PasswordOld}
                          onChange={(e: any) => {
                            onChange_InputChangePassword("PasswordOld", e);
                          }}
                        />
                      </div>
                      <div className="row mb-3">
                        <CInput
                          ...
                          value={InputChangePassword.PasswordNew}
                          onChange={(e: any) => {
                            onChange_InputChangePassword("PasswordNew", e);
                          }}
                        />
                      </div>
                      <div className="text-center">
