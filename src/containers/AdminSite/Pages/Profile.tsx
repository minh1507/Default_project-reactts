                    ...
                    <div className="card-body pt-3">
                        ...
                        <div className="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                            ...
                            <div className="row mb-3">
                                <CInput key="fullname" placeholder='Họ và tên' value={InputProfile.FullName} onChange={(e:any) => {onChange_InputProfile('FullName', e)}} /> 
                            </div>
                            <div className="row mb-3">
                                <CInput key="username" disabled={true} placeholder='Tên đăng nhập' value={InputProfile.UserName} onChange={(e:any) => {onChange_InputProfile('UserName', e)}} /> 
                            </div>
                            <div className="row mb-3">
                                <CInput key="email" placeholder='Email' value={InputProfile.Email} onChange={(e:any) => {onChange_InputProfile('Email', e)}} />
                            </div>
                            <div className="row mb-3">
                                <CInput key="phone" placeholder='SĐT' value={InputProfile.Phone} onChange={(e:any) => {onChange_InputProfile('Phone', e)}} />
                            </div>
                            <div className="row mb-3">
                                <CInput key="address" placeholder='Địa chỉ' value={InputProfile.Address} onChange={(e:any) => {onChange_InputProfile('Address', e)}} />
                            </div>
                            <div className="text-center">                            
                                <CButton title='Lưu' onClick={SaveProfile} />
                            </div>
                        ...
                        <div className="tab-pane fade pt-3" id="profile-change-password">
                            ...
                            <form style={{"width" : "50%"}}>
                            <div className="row mb-3">
                                <CInput type='password' key="oldpassword" placeholder='Mật khẩu cũ' value={InputChangePassword.PasswordOld} onChange={(e:any) => {onChange_InputChangePassword('PasswordOld', e)}} /> 
                            </div>
                            <div className="row mb-3">
                                <CInput type='password' key="newpassword" placeholder='Mật khẩu mới' value={InputChangePassword.PasswordNew} onChange={(e:any) => {onChange_InputChangePassword('PasswordNew', e)}} /> 
                            </div>
                            <div className="text-center">
                                <CButton title='Đổi mật khẩu' onClick={ChangePassword} />
                            </div>
